...
pp = PdfPages('output21'+ext+'/feature_corner.pdf')
...
plt.xlabel(r'$X_1$')
plt.ylabel(r'$EW_{Si}$')
pp = PdfPages('output21'+ext+'/x1si.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
# filename = 'output21'+ext+'/residual.pdf'
...
# fig.subplots_adjust(hspace=.3)
# fig.set_size_inches(8,11)
# filename = 'output21'+ext+'/residualx1.pdf'
# pp = PdfPages(filename)
# plt.savefig(pp,format='pdf')
# pp.close()
# plt.close()
...
plt.xlabel(r'$\Delta$')
pp = PdfPages('output21'+ext+'/Delta_hist.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
plt.xlabel(r'$A_V$')
pp = PdfPages('output21'+ext+'/AV_hist.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
plt.xlabel(r'$A_V$')
pp = PdfPages('output21'+ext+'/AV_mode_hist.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()

plt.hist(fit['RV'].flatten(),normed=True,bins=20)
plt.xlabel(r'$R_V$')
pp = PdfPages('output21'+ext+'/RV_hist.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()

plt.hist(numpy.median(fit['RV'],axis=0),normed=True,bins=20)
plt.xlabel(r'$R_V$')
pp = PdfPages('output21'+ext+'/RV_med.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
pp = PdfPages('output21'+ext+'/beta_corner.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
pp = PdfPages('output21'+ext+'/eta_corner.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
pp = PdfPages('output21'+ext+'/sigma_corner.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()


with PdfPages('output21'+ext+'/multipage_pdf.pdf') as pdf:
...
#     pp = PdfPages('output21/coeff{}.pdf'.format(index))
#     plt.savefig(pp,format='pdf')
#     pp.close()
#     plt.close()
...
for ax in figure.get_axes():
    ...
    for tick in ax.yaxis.get_major_ticks():
        tick.label.set_fontsize(18) 
pp = PdfPages('output21'+ext+'/perobject_corner.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
