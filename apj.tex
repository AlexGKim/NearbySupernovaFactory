...
an empirical model for SN~Ia peak magnitudes with two color parameters and dependence on the equivalent widths of Ca~II, Si~II, and Si~II velocity
...
by Si~II velocity with differing $B_{\mathit{\mathit{max}}}-V_{\mathit{max}}$; this color correlation, in addition to one with $B-R$, is confirmed by
...
The 
\color{red}
spectroscopic-feature measurements are presented
\color{black}
...
\color{black}
and the ideogram of $\gamma^0_{\hat{V}} k_0$ 
...
which  is associated with extinction corrections due to deviations away from the canonical $\langle R^F_{\mathit{eff}}\rangle$ value (right).
   \label{k0_med:fig}}
\end{figure}
...
Figure~\ref{k0_med:fig} shows the histogram of median values
\color{red}
from Monte Carlo chains
\color{black}
and ideogram of $\gamma^1_{\hat{V}} k_1$
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   ...
   \includegraphics[width=2.8in]{output25/ebv_delta.pdf}
      \caption{Left: Ideograms of the external $E({\hat{B}}-{\hat{V}})$ 
      \color{red}
