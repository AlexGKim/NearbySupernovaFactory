...
are aggregated and shown in Figures~\ref{simglobal1:fig}--\ref{simglobal5:fig}.  The input parameters are recovered well
within the 68\% credible interval.  There is a tendency for the slope parameters to be slightly underestimated, which is an expected consequence of 
...
the use of a fiducial template necessary to predict broadband fluxes generated by dust models.
\color{black}
