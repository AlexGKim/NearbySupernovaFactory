...
of the vectors corresponding to $\gamma^i_X/(\gamma^i_B-\gamma^i_V)$ of our model (solid lines),
   ...
   lines: they are almost perfectly superimposed on $\gamma^0_X/(\gamma^0_B-\gamma^0_V)$ for $UVI$ and $BVR$ respectively.  $b(X)$ shown in the dotted line is
...
the dust vector $a(X)+\kappa_1 b(X)$  and $\gamma^1_X$
is aligned with $\kappa_2 a(X) + b(X)$  $UVI$-space.  
%With these values of $\kappa$, the dust parameters are $R^F_0=2.4$ and $\Delta R^F=1.4$.
Slightly shifted values of $\kappa_1=1/2.6$, $\kappa_2=-6.1$ apply in $BVR$-space.
%, which correspond to  $R^F_0=2.6$ and $\Delta R^F=1.4$.
...
measurement uncertainty are the only sources of variation in magnitudes.  As with the analysis of our data, we find that the
