...
Suppose that the data were due to a dust model with constant $R \equiv A_V/E(B-V)$.
The  $A_V$ and $E(B-V)$ parameters of the dust model in Eqn.~\ref{f99:eqn} would then be correlated.
An alternative parameterization 
\begin{equation}
A_X = A_V \left(a(X)  +  \frac{b(X)}{R}\right),
\end{equation}

A prior that $k_0$ and  $k_1$ be uncorrelated was enforced to break degeneracies in our linear models.
These determine the choice of directions of
the vectors $\pmb{\gamma}^0$ and $\pmb{\gamma}^1$.
and so the $\gamma$'s 

   Then a \citetalias{1999PASP..111...63F}  dust model 
can be written in a new basis
...
\end{equation}
with the parameters $\kappa_1$ and $\kappa_2$ parameterizing the directions of the two new basis vectors.
