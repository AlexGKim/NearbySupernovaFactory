...
\color{red}
\citep{2017ApJ...842...93M}  find an intrinsic dispersion of the SALT2 $c$ parameter (associated with $B-V$) of $\approx 0.07$ mag.
\color{black}
%model11_rubin.py
...
\citet{2017ApJ...842...93M} discuss an instructive simulation
...
This expectation is borne out in Figure 3 of \citet{2017ApJ...842...93M}, which
shows  simulated
...
In our Model~II, each supernova has three color parameters that can contain information on more
...
The shallower (but non-zero) slope at blue color transitioning to a larger slope at red color 
is correspondence with the expectation of a mixed intrinsic--dust model.
The fact that
, and is seen in their data Figure 6 of the form considered by  \citet{2017ApJ...842...93M}.
Slope is not zero.
