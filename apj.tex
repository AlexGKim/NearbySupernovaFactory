...
$\vec{\alpha}$, $\vec{\beta}$,  and $\pmb{\eta}$,  are the intercept and slopes of the linear relationships that
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   ...
   \includegraphics[width=5.2in]{output11/coeff0.pdf} 
            \caption{Model~I posterior contours for $\vec{c}$, $\vec{\alpha}$, $\vec{\beta}$, $\pmb{\eta}$, $\vec{\gamma}^0$, $\vec{\gamma}^1$, and $\sigma$ in the ${\hat{U}}$ band.
            ...
            enclosed probability.  Lines for zero value for $\alpha_{\hat{U}}$, $\beta_{\hat{U}}$, $\eta$, $\gamma_{\hat{U}}^0$, $\gamma_{\hat{U}}^1$, and $\sigma_{\hat{U}}$ are shown for reference --
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   ...
   \includegraphics[width=5.2in]{output11/coeff1.pdf} 
            \caption{Model~I posterior contours for $\vec{c}$, $\vec{\alpha}$, $\vec{\beta}$, $\pmb{\eta}$,  $\vec{\gamma}^0$, $\vec{\gamma}^1$, and $\sigma$ in the ${\hat{B}}$ band.
 \label{global2:fig}}
\end{figure}
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   ...
   \includegraphics[width=5.2in]{output11/coeff2.pdf} 
            \caption{Model~I posterior contours for $\vec{c}$, $\vec{\alpha}$, $\vec{\beta}$, $\pmb{\eta}$, $\vec{\gamma}^0$, $\vec{\gamma}^1$, and $\sigma$ in the ${\hat{V}}$ band.
 \label{global3:fig}}
\end{figure}
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   \centering
      \includegraphics[width=5.2in]{output11/coeff3.pdf} 
            \caption{Model~I posterior contours for  $\vec{c}$, $\vec{\alpha}$, $\vec{\beta}$, $\pmb{\eta}$,  $\vec{\gamma}^0$, $\vec{\gamma}^1$, and $\sigma$ in the ${\hat{R}}$ band.
 \label{global4:fig}}
\end{figure}
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   \centering
         \includegraphics[width=5.2in]{output11/coeff4.pdf} 
            \caption{Model~I posterior contours for  $\vec{c}$, $\vec{\alpha}$, $\vec{\beta}$, $\pmb{\eta}$, $\vec{\gamma}^0$, $\vec{\gamma}^1$, and $\sigma$ in the ${\hat{I}}$ band.
 \label{global5:fig}}
\end{figure}
...
The 
potential scale reduction statistic, $\hat{R}$ (not the passband) \citep{Gelman92}, measures the convergence of the target distribution
...
For each of the five filters, the 68\%  equal-tailed credible intervals for the global parameters $\alpha$, $\beta$, $\eta$, $\vec{\gamma}^0$, $\vec{\gamma}^1$, and $\sigma$
...
The signal in  $\vec{\alpha}$ and $\vec{\beta}$ cannot be attributed to the equivalent widths themselves.
...
Similarly, the CaII H\&K equivalent widths have range $\pm 50$~\AA, while the width of the ${\hat{U}}$ band is
...
ßEach supernova is described by its parameters $\Delta$, $EW_{Ca}$, $EW_{Si}$, $\lambda_{Si}$, $E_{\gamma^0}({\hat{B}}-{\hat{V}})$, and $E_{\gamma^1}({\hat{B}}-{\hat{V}})$.
...
\begin{equation}
A_X = a(X)  A_{\hat{V}} + b(X) E({\hat{B}}-{\hat{V}})
\label{f99:eqn}
\end{equation}
...
the plane defined by the $\vec{\gamma}$ vectors.  We begin discussion on the specific choice of $\vec{\gamma}$  returned by the fit within the context of the \citetalias{1999PASP..111...63F}  dust model. 
While
...
Given the association of  our parameter $\gamma^0_{\hat{V}} k_0$ with changes in $A^F_V$ of an $R^F =\kappa^{-1}_1$ dust-extinction
model up to an additive offset,
...
having  associated $\vec{\gamma}^0$ with an $\langle R^F_{eff}\rangle$, $\vec{\gamma}^1$ is associated with perturbations
away from that effective value.
Let us introduce a new parameter for each supernova, $\delta R$, such that its $R^F =\langle R^F_{eff}\rangle(1+  \delta R)$.
...
The range of ${\hat{B}}-{\hat{V}}$ colors is $> 5 \times$ larger for the external contribution than for the extrinsic dust
component.  
...
The correlation coefficients between the ``intrinsic''  ($A_{\delta {\hat{U}}}$) and ``extrinsic''
($E_{\gamma^0}({\hat{B}}-{\hat{V}})$, $E_{\gamma^1}({\hat{B}}-{\hat{V}})$)  parameters are
...
The $\vec{\gamma}$ residuals $\pmb{\epsilon}_{\gamma^0}$ and
$\pmb{\epsilon}_{\gamma^1} $
...
of the $\vec{\gamma}$'s project onto the plane predicted by the \citetalias{1999PASP..111...63F} dust model.
 $\vec{\delta}$ too
has a significant projection onto the dust plane, as the $\pmb{\epsilon}_{\delta}$ residual contributes 2\% of the length of the $\vec{\delta}$ vector.
...
The evidence for the effect of a third parameter persists in the significant  non-zero  $\delta_X/\delta_{\hat{I}}-1$ values
...
we plot in Figure~\ref{childress:fig} our intrinsic parameter  $A_{\delta {\hat{U}}}$  versus host mass 
...
%---
$\langle A_{\delta {\hat{U}}} \rangle=     -0.0002 \pm    0.0089$ mag,
$\langle A_{\delta {\hat{U}}} \rangle= 0.0025 \pm   0.0073 $ mag
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   ...
   \includegraphics[width=5.2in]{output25_sim/coeff0.pdf} 
            \caption{Aggregated Model~II posterior contours for $c$, $\alpha$, $\beta$, $\eta$, $\vec{\gamma}^0$, $\vec{\gamma}^1$,  $\vec{\delta}$, and $\sigma$ in the ${\hat{U}}$ band of ten independent simulated data sets.  The blue crosshairs denote the input $\vec{\delta}$ used to generate the simulated data.
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   ...
   \includegraphics[width=5.2in]{output25_sim/coeff1.pdf} 
            \caption{Aggregated Model~II posterior contours for $c$, $\alpha$, $\beta$, $\eta$, $\vec{\gamma}^0$, $\vec{\gamma}^1$,  $\vec{\delta}$, and $\sigma$ in the ${\hat{B}}$ band of ten independent simulated data sets.  The blue crosshairs denote the input $\vec{\delta}$ used to generate the simulated data.
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   ...
   \includegraphics[width=5.2in]{output25_sim/coeff2.pdf} 
            \caption{Aggregated Model~II posterior contours for $c$, $\alpha$, $\beta$, $\eta$, $\vec{\gamma}^0$, $\vec{\gamma}^1$,  $\vec{\delta}$, and $\sigma$ in the ${\hat{V}}$ band of ten independent simulated data sets.   The blue crosshairs denote the input $\vec{\delta}$ used to generate the simulated data. \label{simglobal3:fig}}
\end{figure}

\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   \centering
      \includegraphics[width=5.2in]{output25_sim/coeff3.pdf} 
            \caption{Aggregated Model~II posterior contours for $c$, $\alpha$, $\beta$, $\eta$, $\vec{\gamma}^0$, $\vec{\gamma}^1$,  $\vec{\delta}$, and $\sigma$ in the ${\hat{R}}$ band of ten independent simulated data sets.   The blue crosshairs denote the input $\vec{\delta}$ used to generate the simulated data.
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   \centering
         \includegraphics[width=5.2in]{output25_sim/coeff4.pdf} 
            \caption{Aggregated Model~II posterior contours for $c$, $\alpha$, $\beta$, $\eta$, $\vec{\gamma}^0$, $\vec{\gamma}^1$,  $\vec{\delta}$, and $\sigma$ in the ${\hat{I}}$ band of ten independent simulated data sets.  The blue crosshairs denote the input $\vec{\delta}$ used to generate the simulated data.
