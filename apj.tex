...
Differences between the model-predicted versus
\color{orange}
predicted
\color{black}
 supernova colors are shown in Figure~\ref{residual:fig}.
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   ...
   \includegraphics[width=5.2in]{output11/residual.pdf} 
            \caption{Differences between predicted versus predicted colors versus the \color{orange}
predicted
\color{black} color.  For each color, the ideogram of the color differences is
            shown on the right.
            \label{residual:fig}}
\end{figure}
...
measurement uncertainty are the only sources of variation in magnitudes.  The input 2.5 is centered
