...
confidence.
\color{red}
The 68\% credible interval for an effective
%-----
$R^F$ of the sample is 2.31 -- 2.69.
%-----
...
\color{red}
The hat serves as a reminder that these are not standard filters.
\color{black}
...
$\mathbf{c}$ (where $\mathbf{c}=(c_{\hat{U}}, c_{\hat{B}}, c_{\hat{V}}, c_{\hat{R}}, c_{\hat{I}}) $),
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   ...
   \includegraphics[width=5.2in]{output11/coeff0.pdf} 
            \caption{Model~I posterior contours for $\mathbf{c}$, $\pmb{\alpha}$, $\pmb{\beta}$, $\pmb{\eta}$, $\pmb{\gamma}^0$, $\pmb{\gamma}^1$, and $\sigma$ in the ${\hat{U}}$ band.
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   ...
   \includegraphics[width=5.2in]{output11/coeff1.pdf} 
            \caption{Model~I posterior contours for $\mathbf{c}$, $\pmb{\alpha}$, $\pmb{\beta}$, $\pmb{\eta}$,  $\pmb{\gamma}^0$, $\pmb{\gamma}^1$, and $\sigma$ in the ${\hat{B}}$ band.
 \label{global2:fig}}
\end{figure}
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   ...
   \includegraphics[width=5.2in]{output11/coeff2.pdf} 
            \caption{Model~I posterior contours for $\mathbf{c}$, $\pmb{\alpha}$, $\pmb{\beta}$, $\pmb{\eta}$, $\pmb{\gamma}^0$, $\pmb{\gamma}^1$, and $\sigma$ in the ${\hat{V}}$ band.
 \label{global3:fig}}
\end{figure}
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   \centering
      \includegraphics[width=5.2in]{output11/coeff3.pdf} 
            \caption{Model~I posterior contours for  $\mathbf{c}$, $\pmb{\alpha}$, $\pmb{\beta}$, $\pmb{\eta}$,  $\pmb{\gamma}^0$, $\pmb{\gamma}^1$, and $\sigma$ in the ${\hat{R}}$ band.
 \label{global4:fig}}
\end{figure}
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   \centering
         \includegraphics[width=5.2in]{output11/coeff4.pdf} 
            \caption{Model~I posterior contours for  $\mathbf{c}$, $\pmb{\alpha}$, $\pmb{\beta}$, $\pmb{\eta}$, $\pmb{\gamma}^0$, $\pmb{\gamma}^1$, and $\sigma$ in the ${\hat{I}}$ band.
 \label{global5:fig}}
\end{figure}
...
As the $\pmb{\gamma}$ parameters are free up to a multiplicative constant and have non-zero values of $\gamma^i_{\hat{V}}$,
...
only the $ -0.17 \pm 0.05$ between $E_{\gamma^0}({\hat{B}}-{\hat{V}})$ and $EW_{Si}$ has significance much larger than $1 \sigma$.
...
%---- fitz11.py
$\frac{\pmb{\gamma}^0}{\gamma^0_{\hat{B}}-\gamma^0_{\hat{V}}}  =(4.80 ,   3.89,   2.89,   2.22,   1.59)$ and
$ \frac{\pmb{\gamma}^1}{\gamma^1_{\hat{B}}-\gamma^1_{\hat{V}}}=(-3.83 ,  -4.42,  -5.42,  -5.15,  -4.71)$.
%----
...
\begin{equation}
\begin{pmatrix}
 \frac{\pmb{\gamma}^0}{\gamma^0_{\hat{B}}-\gamma^0_{\hat{V}}} \\
\frac{\pmb{\gamma}^1}{\gamma^1_{\hat{B}}-\gamma^1_{\hat{V}}} 
\end{pmatrix}=
\begin{pmatrix}
\begin{array}{rr}
2.82 & 1.15  \\
...
The above result is visualized in Figure~\ref{plane:fig}, which  shows  in the ${\hat{U}}{\hat{V}}I$-subspace two perspectives (left and right columns)
...
they are almost coplanar in ${\hat{U}}{\hat{V}}{\hat{I}}$ (they are slightly less coplanar in ${\hat{B}}{\hat{V}}{\hat{R}}$).  The $\mathbf{a}$ and $\mathbf{b}$ vectors and the $\pmb{\gamma}^0$ and $\pmb{\gamma}^1$
...
Given the association of  our parameter $\gamma^0_{\hat{V}} k_0$ with changes in $A^F_V$ of an $R^F =\kappa^{-1}_1$ dust model up to an additive offset,
...
with the expectation of dust based on the spatial distribution of supernovae within galaxies and the distribution of galaxy orientations with respect to the observer \citep{1998ApJ...502..177H, 2007ApJ...659..122J}.  This distribution is given by the data, and so is not dependent of any knowledge or prior
...
The modes of $\delta_X$ are at $\mp 1.12$, $\mp 0.89$, $\mp 0.36$,  $\mp0.16$, $\pm0.21$ in for $X={\hat{U}}{\hat{B}}{\hat{V}}{\hat{R}}{\hat{I}}$ respectively.
...
The range of ${\hat{B}}-{\hat{V}}$ colors is $> 5$ times larger for the external contribution than for the extrinsic dust
component.  
...
The newly fitted $\pmb{\gamma}$ and  $\pmb{\delta}$ vectors (the latter normalized by $\delta_{\hat{U}}$) can be expressed 
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   ...
   \includegraphics[width=5.2in]{output25_sim/coeff0.pdf} 
            \caption{Aggregated Model~II posterior contours for $c$, $\alpha$, $\beta$, $\eta$, $\pmb{\gamma}^0$, $\pmb{\gamma}^1$,  $\pmb{\delta}$, and $\sigma$ in the ${\hat{U}}$ band of ten independent simulated data sets.  The blue crosshairs denote the input $\pmb{\delta}$ used to generate the simulated data.
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   ...
   \includegraphics[width=5.2in]{output25_sim/coeff1.pdf} 
            \caption{Aggregated Model~II posterior contours for $c$, $\alpha$, $\beta$, $\eta$, $\pmb{\gamma}^0$, $\pmb{\gamma}^1$,  $\pmb{\delta}$, and $\sigma$ in the ${\hat{B}}$ band of ten independent simulated data sets.  The blue crosshairs denote the input $\pmb{\delta}$ used to generate the simulated data.
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   ...
   \includegraphics[width=5.2in]{output25_sim/coeff2.pdf} 
            \caption{Aggregated Model~II posterior contours for $c$, $\alpha$, $\beta$, $\eta$, $\pmb{\gamma}^0$, $\pmb{\gamma}^1$,  $\pmb{\delta}$, and $\sigma$ in the ${\hat{V}}$ band of ten independent simulated data sets.   The blue crosshairs denote the input $\pmb{\delta}$ used to generate the simulated data. \label{simglobal3:fig}}
\end{figure}

\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   \centering
      \includegraphics[width=5.2in]{output25_sim/coeff3.pdf} 
            \caption{Aggregated Model~II posterior contours for $c$, $\alpha$, $\beta$, $\eta$, $\pmb{\gamma}^0$, $\pmb{\gamma}^1$,  $\pmb{\delta}$, and $\sigma$ in the ${\hat{R}}$ band of ten independent simulated data sets.   The blue crosshairs denote the input $\pmb{\delta}$ used to generate the simulated data.
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   \centering
         \includegraphics[width=5.2in]{output25_sim/coeff4.pdf} 
            \caption{Aggregated Model~II posterior contours for $c$, $\alpha$, $\beta$, $\eta$, $\pmb{\gamma}^0$, $\pmb{\gamma}^1$,  $\pmb{\delta}$, and $\sigma$ in the ${\hat{I}}$ band of ten independent simulated data sets.  The blue crosshairs denote the input $\pmb{\delta}$ used to generate the simulated data.
...
%   \includegraphics[width=2.8in]{output25/x1si.pdf}
   \includegraphics[width=5in]{output25/x1D.pdf}
    \caption{The SALT2 $x_1$ versus $A_{\delta {\hat{U}}}  = \delta_{\hat{U}} D$.
   \label{x1:fig}}
\end{figure}
...
we plot in Figure~\ref{childress:fig} our intrinsic parameter  $A_{\delta {\hat{I}}}$  versus host mass 
for the subset of supernovae whose host measurements are given in \citet{2013ApJ...770..108C}.
The average $A_{\delta {\hat{I}}}$'s of the two subsamples are
%---
$\langle A_{\delta {\hat{I}}} \rangle=     -0.0002 \pm    0.0089$ mag,
$\langle A_{\delta {\hat{I}}} \rangle= 0.0025 \pm   0.0073 $ mag
...
The Kolmogorov-Smirnov test is applied on the distribution of $A_{\delta {\hat{I}}}$ of both low- and high-mass samples for
each Monte Carlo link.  The resulting distribution of the two-tailed $p$-value  over all chains spans the possible range from 0 to 1, as shown in Figure~\ref{childress:fig}.  We are unable to perform a constraining test of whether the $A_{\delta {\hat{I}}}$ distributions from low- and high-mass samples
...
\label{interpret:sec}
\color{red}
Supernova colors are expected to be affected by interstellar Milky Way-like dust (e.g.\ as modeled by  \citetalias{1999PASP..111...63F})
...
%This model  does an excellent job in
