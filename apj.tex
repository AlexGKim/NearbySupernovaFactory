...
total-to-selective extinction parameter $R^F$.  The prior of no parameter covariance used in the training, and the deduced color excess
is consistent with $R^F = 2.44$.
...
To constrain the degrees of freedom and degeneracies inherent in the model we
\color{orange}
implement
\color{black}
