...
distribution with a mean of $2.4$ and 0.05 standard deviation.  The $\alpha$, $\beta$, and $\eta$ parameters are set to zero, so that dust and
...
$\gamma$'s and \citetalias{1999PASP..111...63F}  vectors for nearly parallel planes, with the $\gamma^0$ vector consistent with
$\kappa_1=1/2.3$.
...
of the vectors corresponding to $\gamma^i_X/(\gamma^i_B-\gamma^i_V)$ of our model (solid lines),
   ...
   input $R^F$ drawn from a log-normal distribution  with a mean of $2.4$ and 0.05 standard deviation.
