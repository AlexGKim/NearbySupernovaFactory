...
data = {'D': nsne, 'N_mags': 5, 'N_EWs': 2, 'mag_obs': mag_renorm, 'EW_obs': EW_renorm, 'EW_cov': EW_cov, 'mag_cov':mag_cov, \
   ...
   'gamma0_ev':gamma0_ev, 'gamma1_ev':gamma1_ev, 'gamma0_min':gamma0_min, 'gamma0_max': gamma0_max, 'gamma1_min':gamma1_min, 'gamma1_max': gamma1_max,'x1_obs': x1, 'x1_err':x1_err }
...
sm = pystan.StanModel(file='gerard25_x1.stan')
