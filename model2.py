...
init = [{'EW' : EW_renorm, 'c': numpy.random.normal(0,0.02,size=5),\
    ...
    'gamma':numpy.array([1.4,1.2,0.85,0.7])+ numpy.random.normal(0,0.01,size=4), 'k':numpy.random.uniform(-0.02, 0.02, size=nsne-1), 'mag_int':\
...
control = {'stepsize':1.}
fit = sm.sampling(data=data, iter=400, chains=4,control=control,init=init)
