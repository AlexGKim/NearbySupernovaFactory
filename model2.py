...
# init1 = {'EW' : EW_renorm, 'c': numpy.zeros(5), 'alpha': numpy.zeros(5), 'beta':numpy.zeros(5), 'gamma':numpy.zeros(4)+1, 'k':numpy.zeros(nsne-1), 'color_int': color_renorm}#, 'L_sigma_color':numpy.zeros(4)+0.02,'L_Omega_color':numpy.zeros()}
