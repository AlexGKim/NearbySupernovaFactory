...
plt.tight_layout()
pp = PdfPages("output11_sim/plane0.pdf")
plt.savefig(pp,format='pdf')
pp.close()
# ax.yaxis.set_ticks(numpy.arange(-.75,.76,.25))
# ax.xaxis.set_ticks(numpy.arange(-.5,.76,.5))
plt.tight_layout()
ax.view_init(elev=7, azim=-157)
pp = PdfPages("output11_sim/plane1.pdf")
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
plt.tight_layout()
pp = PdfPages("output11_sim/plane0BVR.pdf")
plt.savefig(pp,format='pdf')
pp.close()
...
ax.xaxis.set_ticks(numpy.arange(-.5,.76,.5))
plt.tight_layout()
pp = PdfPages("output11_sim/plane1BVR.pdf")
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
plt.xlim((-0.1,0.4))
plt.ylim((-0.7,1.2))
pp = PdfPages("output11_sim/avebv.pdf")
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
plt.ylim((-2,5))
plt.legend(loc=4)
pp = PdfPages("output11_sim/rv.pdf")
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
plt.legend()
pp = PdfPages("output11_sim/avebv_synth.pdf")
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
plt.xlabel(r'$E^F(B-V)_{eff} + const$')
plt.ylim((-1,5))
pp = PdfPages("output11_sim/avrv_synth.pdf")
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
