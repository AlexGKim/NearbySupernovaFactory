...
pp = PdfPages('temp/sigevhist.pdf')
plt.savefig(pp,format='pdf',bbox_inches='tight')
pp.close()
plt.close()
...
# pp = PdfPages('temp/col_corner.pdf')
...
# plt.legend()
# pp = PdfPages('temp/ebv_gamma0.pdf')
# plt.savefig(pp,format='pdf')
# pp.close()
# plt.close()
...
plt.tight_layout()
pp = PdfPages('temp/gamma0_med.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
plt.tight_layout()
pp = PdfPages('temp/deltagamma0_med.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
plt.yticks(fontsize=18)
plt.tight_layout()
pp = PdfPages('temp/deltagamma1_med.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
plt.legend(loc=2)
plt.tight_layout()
pp = PdfPages('temp/gamma1_med.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
plt.legend()
pp = PdfPages('temp/ebv_gamma1.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
pp = PdfPages('temp/feature_corner.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
pp = PdfPages("temp/egammaedelta_corner.pdf")
plt.savefig(pp,format='pdf')
pp.close()
plt.close()


(y, ymin, ymax) = numpy.percentile(fit['EW2'][:,:],(50,50-34,50+34),axis=0)
plt.errorbar(x1, y, xerr=[x1_err,x1_err],yerr=[y-ymin,ymax-ymin],fmt='o')
plt.xlabel(r'$X_1$')
plt.ylabel(r'$EW_{Si}$')
pp = PdfPages("temp/x1si.pdf")
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
filts = ['U','B','V','R','I']
correction = [fit['Delta']+ fit['c'][:,i][:,None] + fit['alpha'][:,i][:,None]*fit['EW1'][:,:] \
    + fit['beta'][:,i][:,None]*fit['EW2'][:,:] + fit['eta'][:,i][:,None]*fit['sivel']+ fit['zeta'][:,i][:,None]*fit['x1']\
...
correction = [fit['c'][:,i][:,None] + fit['alpha'][:,i][:,None]*fit['EW1'][:,:] \
    + fit['beta'][:,i][:,None]*fit['EW2'][:,:] + fit['eta'][:,i][:,None]*fit['sivel']+ fit['zeta'][:,i][:,None]*fit['x1']\
    + fit['gamma'][:,i][:,None]*fit['k']+ fit['rho1'][:,i][:,None]*fit['R'] + (fit['ev_sig']*fit['ev'][:,i])[:,None]* fit['mag_int_raw'] \
    for i in xrange(5)]
...
# fig.set_size_inches(8,11)
# # plt.tight_layout()
# filename = 'temp/residual_temp.pdf'
# pp = PdfPages(filename)
# plt.savefig(pp,format='pdf')
# pp.close()
...
# fig.set_size_inches(8,11)
# # plt.tight_layout()
# filename = 'temp/residual_temp2.pdf'
# pp = PdfPages(filename)
# plt.savefig(pp,format='pdf')
# pp.close()
...
plt.legend()
plt.xlabel(r'$\Delta$')
pp = PdfPages('temp/Delta_hist.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
# pp = PdfPages('temp/Delta1sigvsDelta.pdf')
# plt.savefig(pp,format='pdf')
# pp.close()
# plt.close()
...
# pp = PdfPages('temp/sigmadiffvsDelta.pdf')
# plt.savefig(pp,format='pdf')
# pp.close()
# plt.close()
...
# plt.ylabel(r'$-1\sigma / +1\sigma$')
# pp = PdfPages('temp/deltasigmadiffvsDelta.pdf')
# plt.savefig(pp,format='pdf')
# pp.close()
# plt.close()
...
# pp = PdfPages('temp/deltaDelta_vs_z.pdf')
# plt.savefig(pp,format='pdf')
# pp.close()
# plt.close()
...
# plt.ylabel(r'$\delta \Delta$')
# pp = PdfPages('temp/deltaDelta_hist.pdf')
# plt.savefig(pp,format='pdf')
# pp.close()
# plt.close()
...
plt.ylabel(r'$\Delta$')
plt.xlabel(r'$z_{\odot}$')
pp = PdfPages('temp/Delta_vs_z.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
plt.ylabel(r'$\Delta$')
plt.xlabel(r'$U-V$')
pp = PdfPages('temp/Delta_vs_u-v.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
plt.ylabel(r'$\Delta$')
plt.xlabel(r'$I-V$')
pp = PdfPages('temp/Delta_vs_i-v.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
pp = PdfPages('temp/Delta_med_hist.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
# pp = PdfPages('temp/alpham4_corner.pdf')
# plt.savefig(pp,format='pdf')
# pp.close()
# plt.close()
...
pp = PdfPages('temp/beta_corner.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
pp = PdfPages('temp/eta_corner.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
# pp = PdfPages('temp/betam4_corner.pdf')
# plt.savefig(pp,format='pdf')
# pp.close()
# plt.close()
...
pp = PdfPages('temp/gamma_corner.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()

figure = corner.corner(fit['rho1'],labels=[r"${\rho}_{10}$",r"${\rho}_{11}$",r"${\rho}_{12}$",r"${\rho}_{13}$",r"${\rho}_{14}$"])
pp = PdfPages('temp/rho_corner.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()


with PdfPages('temp/multipage_pdf.pdf') as pdf:
    ...
    plt.plot(fit['EW1'][::10,:10])
    plt.title('EW - 0')
    pdf.savefig()
    plt.close()

    plt.plot(fit['EW2'][::10,:10])
    plt.title('EW - 1')
    pdf.savefig()
    plt.close()
    ...
    pp = PdfPages('temp/rx_corner.pdf')
    plt.savefig(pp,format='pdf')
    pp.close()
    plt.close()
    ...
    pp = PdfPages('temp/rxdelta_corner.pdf')
    plt.savefig(pp,format='pdf')
    pp.close()
    plt.close()
...
fig.savefig('temp/perobject_corner.pdf',bbox_inches='tight')
...
#     for tick in ax.yaxis.get_major_ticks():
#         tick.label.set_fontsize(14) 
# pp = PdfPages('temp/perobject_corner.pdf')
# plt.savefig(pp,format='pdf')
# pp.close()
plt.close()
plt.clf()
...
for index in xrange(5):
    ...
    fig.savefig(filename='temp/coeff{}.pdf'.format(index),bbox_inches='tight')
...
c.plotter.plot(filename='temp/sigev.pdf',figsize="column", truth=numpy.zeros(5))
