...
gamma0_min = numpy.min(gamma0_eval,axis=0)-0.1
gamma0_max = numpy.max(gamma0_eval,axis=0)+0.1
...
gamma1_min = numpy.min(gamma1_eval,axis=0)-1
gamma1_max = numpy.max(gamma1_eval,axis=0)+1
...
sm = pystan.StanModel(file='fix4.stan')
