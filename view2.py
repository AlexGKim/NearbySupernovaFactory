...
for i, fi in enumerate(filtname):
    ...
    pp = PdfPages('output/magresidual_{}.pdf'.format(fi))
...
pp = PdfPages('output/sigma_corner.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
