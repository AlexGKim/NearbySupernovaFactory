...
results consistent
with two-parameter dust models.  An extension to our model is now added to accommodate
...
absolute magnitudes through global coefficients $\delta$. 
Although
...
deviations of the residuals in the $V$ and $I$ bands.
The newly fitted $\delta$ parameters have an almost identical association with the Fitzpatrick dust law, in that now
\begin{equation}
\begin{pmatrix}
 \frac{\gamma^0_X}{\gamma^0_1-\gamma^0_2} \\
\frac{\gamma^1_X}{\gamma^1_1-\gamma^1_2} 
...
%-----
mag respectively.
The range of $B-V$ colors is $\sim 8$ times larger for the external contribution; variation in $B-V$ color due to the intrinsic term is dwarfed by the extrinsic process. 
...
of the null result $\delta_X=0$ for all $X$ is $<98\%$, determined through
