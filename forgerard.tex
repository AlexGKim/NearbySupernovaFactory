...
\right),
\end{equation}
The data are the colors and equivalent widths on the left side.  There are global parameters $c$, $\alpha$, $\beta$, and $\gamma$.  Each
...
\left(
\begin{matrix}
U-V +\gamma_0 k \\B-V +\gamma_1 k \\V-R+\gamma_2 k\\V-I+\gamma_3 k\\
EW_{Si}\\ EW_{Ca}
\end{matrix}
\right)
,C
