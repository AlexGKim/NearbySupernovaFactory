...
assigning the blue-extreme colors of this set close to  zero color excess, 
...
At extreme blue effective color there is a tight range of  $R_{eff,U} - R_{eff,V}$ values.  The distribution spreads to significantly 
lower   $R_{eff,U} - R_{eff,V}$ as supernovae appear redder but
then reconverge to higher, tighter values at extreme red effective color.
The variation in  $R_{eff,U} - R_{eff,V}$ is attributed to the varying contributions of internal and external color excess: the bottom plot of
Figure~\ref{rveff:fig} shows that the shift to lower values occurs when the effective color excess is dominated by the internal contribution. 
...
at low $E_{eff}(X-V)$.
 ...
 low values of $R_{eff,U} - R_{eff,V}$ as implying high values of $R_V$ (see Figure~\ref{ebv:fig}),   and would hence infer a
 broad range of  $R_V$ at bluer colors, and a narrow range of low $R_V$  for the reddest supernovae.
