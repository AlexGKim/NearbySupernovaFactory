...
\author
{
    ...
    P.~Antilogus,\altaffilmark{3}
    S.~Bailey,\altaffilmark{1}
    C.~Baltay,\altaffilmark{4}
    K.~Barbary,\altaffilmark{5}
    D.~Baugh,\altaffilmark{6}
    K.~Boone,\altaffilmark{1,5}
    S.~Bongard,\altaffilmark{3}
    C.~Buton,\altaffilmark{2}
    J.~Chen,\altaffilmark{6}
    N.~Chotard,\altaffilmark{2}
    Y.~Copin,\altaffilmark{2}
    P.~Fagrelius,\altaffilmark{1,5}
    H.~K.~Fakhouri,\altaffilmark{1,5}
    U.~Feindt,\altaffilmark{7}
    D.~Fouchez,\altaffilmark{8}
    E.~Gangler,\altaffilmark{9}  
    B.~Hayden,\altaffilmark{1}
    W.~Hillebrandt,\altaffilmark{10}
    M.~Kowalski,\altaffilmark{11,12}
    P.-F.~Leget,\altaffilmark{9}
    S.~Lombardo,\altaffilmark{11}
    J.~Nordin,\altaffilmark{11}
    R.~Pain,\altaffilmark{3} 
    E.~Pecontal,\altaffilmark{13}
    R.~Pereira,\altaffilmark{2}
    S.~Perlmutter,\altaffilmark{1,5}
    D.~Rabinowitz,\altaffilmark{4}
    M.~Rigault,\altaffilmark{11} 
    D.~Rubin,\altaffilmark{1,14}
    K.~Runge,\altaffilmark{1}
    C.~Saunders,\altaffilmark{1,5}
    C.~Sofiatti,\altaffilmark{1,5} 
    N.~Suzuki,\altaffilmark{1}
    S.~Taubenberger,\altaffilmark{10}
    C.~Tao,\altaffilmark{6,8}
...
our Monte Carlo chains for $\delta$ exceed 0 (see Figure~\ref{global:fig}), we thus claim detection of the
