...
\label{model2:sec}
In \S\ref{model:sec} we show that the SNf data analyzed with an agnostic 2-parameter model produces
results consistent
...
The newly fitted $\delta$ parameters have an almost identical association with the Fitzpatrick dust law, in that
\begin{equation}
\begin{pmatrix}
 \frac{\gamma^0_X}{\gamma^0_1-\gamma^0_2} \\
\frac{\gamma^1_X}{\gamma^1_1-\gamma^1_2} 
...
in Figure~\ref{deltacorner:fig}. The left plot shows the $\delta$ posteriors, which is bimodal due to the sign-flip degeneracy.  The probability
...
is that the shift in magnitude is not monotonic in redshift, but rather decreases from $U$ to $V$, and then increases from $V$
to $I$.
...
describing SN~2014J, a supernova not used in the training that has extreme colors.  An extended version
...
\citep{2010A&A...523A...7G}, showing that our model exhibits no clear loss in our ability to standardize
...
$   0.0042 \pm    0.0014$
($   0.0031 \pm    0.0017$).  A significant difference is not found.
...
s     \includegraphics[width=2.8in]{output15/rigault2.pdf}
      \caption{\textcolor{red}{Left: Intrinsic parameter $A_I=\delta_I D$  versus host mass.  Hosts too faint for a mass measurement
