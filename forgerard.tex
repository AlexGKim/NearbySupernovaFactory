...
%------
for the full sample, and a difference in the average $R^F_V$ between extremely blue and red supernovae .  The derived dust law is able to reproduce the optical colors of the highly reddened SN~2014J.
Extending the model to allow three color parameters gives a detection of a third parameter at  $>98$\% confidence.
\color{black}
\end{abstract}
...
closest to maximum is used \citep{chotard:thesis}.
...
For a linear 2-parameter model, possible magnitudes are confined to a plane on the 5-dimensional magnitude space.
...
$k_0$, $k_1$, $\gamma^0$, $\gamma^1$ describe for the most part
external dust.
...
\label{model2:sec}
In \S\ref{model:sec} we show that the SNf data analyzed with an agnostic model with
...
describing SN~2014J, a supernova with extreme colors not used in the training.  An extended version
of the model retains the features of the first model, and gives strong evidence for a new parameter that affects supernova
