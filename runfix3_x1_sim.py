...
def main(args):
   ...
   for index in xrange(int(args['minin']),int(args['maxin'])):
      ...
      data['rho1_ev']=gamma1_ev
      data['rho1_min']=gamma1_min
      data['rho1_max']=gamma1_max
      ...
      init = [{'EW' : data['EW_obs'], \
               ...
               'gamma04': gamma0[3],\
               'gamma05': gamma0[4],\
               'mag_int_raw': numpy.median(data['mag_obs'],axis=1), \
      ...
      output = open('fix3_x1_sim'+tag+'{}.pkl'.format(index),'wb')
