...
pp = PdfPages("output11/deltakk.pdf")
plt.tight_layout()
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
fig.set_size_inches(8,11)
# plt.tight_layout()
filename = 'output11/residual_temp.pdf'
pp = PdfPages(filename)
plt.savefig(pp,format='pdf')
pp.close()
...
fig.set_size_inches(8,11)
# plt.tight_layout()
filename = 'output11/residual_temp2.pdf'
pp = PdfPages(filename)
plt.savefig(pp,format='pdf')
pp.close()
...
pp = PdfPages('output11/Delta1sigvsDelta.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
pp = PdfPages('output11/sigmadiffvsDelta.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
# plt.ylabel(r'$-1\sigma / +1\sigma$')
# pp = PdfPages('output11/deltasigmadiffvsDelta.pdf')
# plt.savefig(pp,format='pdf')
# pp.close()
# plt.close()
...
# plt.xlabel(r'$z_{\odot}$')
# pp = PdfPages('output11/deltaDelta_vs_z.pdf')
# plt.savefig(pp,format='pdf')
# pp.close()
# plt.close()
...
# plt.ylabel(r'$\delta \Delta$')
# pp = PdfPages('output11/deltaDelta_hist.pdf')
# plt.savefig(pp,format='pdf')
# pp.close()
# plt.close()
...
plt.hist((fit['Delta']-fit['Delta'][:,0][:,None]).flatten(),bins,label='ideogram',normed=True,alpha=0.5)
...
fig.set_size_inches(8,11)
# plt.tight_layout()
filename = 'output11/residual_fg.pdf'
pp = PdfPages(filename)
plt.savefig(pp,format='pdf')
pp.close()