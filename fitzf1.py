...
pp = PdfPages("output_fix1/plane0.pdf")
# plt.tight_layout()
...
pp = PdfPages("output_fix1/plane1.pdf")
# plt.tight_layout()
plt.savefig(pp,format='pdf',bbox_inches='tight')
pp.close()
plt.close()
...
ax.yaxis.set_ticks(numpy.arange(-.8,.81,.4))
ax.view_init(elev=2, azim=-114)
pp = PdfPages("output_fix1/plane0BVR.pdf")
plt.tight_layout()
...
ax.yaxis.set_ticks(numpy.arange(-.75,.76,.25))
ax.xaxis.set_ticks(numpy.arange(-.5,.76,.5))
pp = PdfPages("output_fix1/plane1BVR.pdf")
plt.tight_layout()
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
# plt.xlim((-0.1,0.4))
# plt.ylim((-0.7,1.2))
# pp = PdfPages("output_fix1/avebv.pdf")
# plt.savefig(pp,format='pdf')
# pp.close()
# plt.close()
...
# plt.ylim((-2,5))
# plt.legend(loc=4)
# pp = PdfPages("output_fix1/rv.pdf")
# plt.savefig(pp,format='pdf')
# pp.close()
# plt.close()
...
# plt.legend(loc=4)
# pp = PdfPages("output_fix1/avebv_synth.pdf")
# plt.savefig(pp,format='pdf')
# pp.close()
# plt.close()