...
# pp = PdfPages('output_fix3/col_corner.pdf')
...
# plt.legend()
# pp = PdfPages('output_fix3/ebv_gamma0.pdf')
# plt.savefig(pp,format='pdf')
# pp.close()
# plt.close()
...
# plt.legend()
# plt.tight_layout()
# pp = PdfPages('output_fix3/gamma0_med.pdf')
# plt.savefig(pp,format='pdf')
# pp.close()
# plt.close()
...
plt.yticks(fontsize=18)
plt.tight_layout()
pp = PdfPages('output_fix3/deltagamma1_med.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
plt.clf()
...
plt.legend(loc=2)
plt.tight_layout()
pp = PdfPages('output_fix3/gamma1_med.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
pp = PdfPages("output_fix3/deltakk.pdf")
plt.tight_layout()
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
pp = PdfPages("output_fix3/kk.pdf")
plt.tight_layout()
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
# pp = PdfPages("output_fix3/ra.pdf")
# plt.tight_layout()
# plt.savefig(pp,format='pdf')
# pp.close()
# plt.close()
...
plt.legend()
pp = PdfPages('output_fix3/ebv_gamma1.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
pp = PdfPages('output_fix3/feature_corner.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
pp = PdfPages("output_fix3/egammaedelta_corner.pdf")
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
plt.xlabel(r'$X_1$')
plt.ylabel(r'$EW_{Si}$')
pp = PdfPages("output_fix3/x1si.pdf")
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
pp = PdfPages("output_fix3/x1D.pdf")
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
plt.xlabel(r'$A_V$')
pp = PdfPages("output_fix3/Av_med.pdf")
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
pp = PdfPages("output_fix3/Rveff4.pdf")
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
pp = PdfPages("output_fix3/Rveff.pdf")
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
pp = PdfPages("output_fix3/Rveff2.pdf")
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
plt.ylabel(r'$R_{eff,U} - R_{eff,V}$')
pp = PdfPages("output_fix3/Rveff3.pdf")
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
for i in xrange(4):
    ...
    axes[i,0].set_xlabel( \
        r'$\hat{{{0}}} - \hat{{V}} +(\gamma^0_\hat{{{0}}}-\gamma^0_\hat{{V}}) g_0+ (\gamma^1_\hat{{{0}}}-\gamma^1_\hat{{V}})  g_1+ (\phi_\hat{{{0}}}-\phi_\hat{{V}})p$'.format(cname[i]))
...
plt.legend()
plt.xlabel(r'$\Delta$')
pp = PdfPages('output_fix3/Delta_hist.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
# plt.ylabel(r'$-1\sigma / +1\sigma$')
# pp = PdfPages('output_fix3/deltasigmadiffvsDelta.pdf')
# plt.savefig(pp,format='pdf')
# pp.close()
# plt.close()
...
# pp = PdfPages('output_fix3/deltaDelta_vs_z.pdf')
# plt.savefig(pp,format='pdf')
# pp.close()
# plt.close()
...
# plt.ylabel(r'$\delta \Delta$')
# pp = PdfPages('output_fix3/deltaDelta_hist.pdf')
# plt.savefig(pp,format='pdf')
# pp.close()
# plt.close()
...
pp = PdfPages('output_fix3/Delta_med_hist.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
plt.title(r'$k$')
pp = PdfPages('output_fix3/k_hist.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
plt.title(r'$D$')
pp = PdfPages('output_fix3/D_hist.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
pp = PdfPages('output_fix3/ebvvsobs.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
plt.xlabel(r'$E_\gamma(B-V)$')
plt.ylabel(r'$B_o$')
pp = PdfPages('output_fix3/g1.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
plt.xlabel(r'$E_\gamma(B-V)$')
plt.ylabel(r'$U_o$')
pp = PdfPages('output_fix3/g1u.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
pp = PdfPages('output_fix3/g2uc.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
pp = PdfPages('output_fix3/g2.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
plt.legend()
pp = PdfPages('output_fix3/ebv.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
# plt.ylim((-0.8,0.1))
# pp = PdfPages('output_fix3/Rveffres.pdf')
# plt.savefig(pp,format='pdf')
# pp.close()
# plt.close()
...
# pp = PdfPages('output_fix3/ebvebv.pdf')
# plt.savefig(pp,format='pdf')
# pp.close()
# plt.close()
...
# pp = PdfPages('output_fix3/alpham4_corner.pdf')
# plt.savefig(pp,format='pdf')
# pp.close()
# plt.close()
...
pp = PdfPages('output_fix3/beta_corner.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
pp = PdfPages('output_fix3/eta_corner.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
# pp = PdfPages('output_fix3/betam4_corner.pdf')
# plt.savefig(pp,format='pdf')
# pp.close()
# plt.close()
...
pp = PdfPages('output_fix3/gamma_corner.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()

figure = corner.corner(fit['rho1'],labels=[r"${\rho}_{10}$",r"${\rho}_{11}$",r"${\rho}_{12}$",r"${\rho}_{13}$",r"${\rho}_{14}$"])
pp = PdfPages('output_fix3/rho_corner.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()


with PdfPages('output_fix3/multipage_pdf.pdf') as pdf:
    ...
    pp = PdfPages('output_fix3/rx_corner.pdf')
    plt.savefig(pp,format='pdf')
    pp.close()
    plt.close()
    ...
    pp = PdfPages('output_fix3/rxdelta_corner.pdf')
    plt.savefig(pp,format='pdf')
    pp.close()
    plt.close()
...
# pp = PdfPages('output_fix3/fitz.pdf')
# plt.savefig(pp,format='pdf')
# pp.close()
# plt.close()
...
for index in xrange(5):
    ...
    pp = PdfPages('output_fix3/coeff{}.pdf'.format(index))
    plt.savefig(pp,format='pdf')
    pp.close()
    plt.close()
...
pp = PdfPages('output_fix3/ccm.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
pp = PdfPages('output_fix3/ccm2.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
pp = PdfPages('output_fix3/deltaratio.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
for ax in figure.get_axes():
    ...
    for tick in ax.yaxis.get_major_ticks():
        tick.label.set_fontsize(14) 
pp = PdfPages('output_fix3/perobject_corner.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
