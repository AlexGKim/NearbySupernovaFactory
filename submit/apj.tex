...
\author{     D.~Fouchez}
\affiliation{    Aix Marseille Univ, CNRS/IN2P3, CPPM, 
...
\color{red}
The spectral features are in \AA\ units.
\color{black}
...
\color{red}
The units of $\vec{c}$ are mag, the units of $\vec{\alpha}$, $\vec{\beta}$,  and $\vec{\eta}$ are mag~\AA$^{-1}$.
\color{black}
...
all components are written as a vector, e.g.\ $\vec{c}$.  This provides a notational distinction between these global parameters and per-supernova parameters.
\color{black}
...
\color{red}
and hence favors $\gamma$'s that minimize residual dispersion;
\color{black}
...
\color{red}
This is parameterized by the Choleksy factor of its
\color{black}
...
\citep{Lewandowski20091989} and its standard
...
deduced colors versus observed colors and the histogram of their differences
is shown in Figure~\ref{residual:fig}. 
\color{red} The deduced colors  account for supernova-specific spectral features and $\gamma k$ terms.
\color{black}
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   ...
   \includegraphics[width=5.2in]{residual.pdf} 
            \caption{
            Deduced colors versus observed colors, for four selected colors. 
            \color{red} The deduced colors  account for supernova-specific spectral features and $\gamma k$ terms.
            \color{black}
            Plotted on the right for each color
is the histogram of the difference between the observed and
\color{red}
 deduced
 \color{black}
 colors.
...
correlation by
\color{red}
selecting an arbitrary supernova and subtracting out its $\Delta|_0$ from those of all other objects, for each link of the MCMC. \color{black}
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   ...
   \color{red}  To help null correlated errors, we select
    an arbitrary supernova and subtract out its $\Delta|_0$ from those of all other objects, for each link of the MCMC.
   \color{black}
...
\color{red}
Note that underestimated measurement uncertainties in $C$ could lead to non-intrinsic contributions to
$C_c$; we do not further examine this systematic error in this article.
\color{black}
...
and the  \color{red} stack of the posteriors of all supernovae \color{black}  of $\gamma^0_{\hat{V}} k_0$ 
...
The distributions of both sources of color excess $E({\hat{B}}-{\hat{V}})$ and
 $E_\delta({\hat{B}}-{\hat{V}}) \equiv   (\delta_{\hat{B}}-\delta_{\hat{V}})D$ are shown in the  \color{red} stack of the posteriors of all supernovae \color{black}  
...
\color{red}
We also highlight that the standard deviations of $C_c$ are not biased high, which would be a signature of leakage of
intrinsic color variations $\delta$ into intrinsic dispersion.
\color{black}
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   ...
   \includegraphics[width=5.2in]{residualx1.pdf}
    \caption{Differences between observed colors and the colors
    \color{red}
    deduced \color{black}
