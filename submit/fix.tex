...
dust-based $a(X)$ and $b(X)$ vectors plus residual vectors perpendicular to $\vec{a}$ and $\vec{b}$,
\begin{equation}
\begin{pmatrix}
\vec{\gamma}^0 \\
\vec{\gamma}^1
...
$a(X)$ and $b(X)$, the quadratic fraction of $\vec{\gamma}^1$ projected
...
All color changes would then be confined to the $a(X)+\kappa_1 b(X)$ direction. This scenario corresponds to the \citetalias{1999PASP..111...63F}  dust model restricted to a constant $R^F=\kappa_1^{-1}$.   We use this interpretation to assign  $\langle R^F_{\mathit{eff}}\rangle = \kappa_1^{-1}$ as
the
ensemble mean
effective total-to-selective extinction of our sample.
With our posterior we
get $\kappa^{-1}_1=2.18^{+0.14}_{-0.16}$.
...
Figure~\ref{k0_med:fig} shows the histogram of per-supernova
median values
from Monte Carlo chains
and  stack of the posteriors of all supernovae  of $\gamma^1_{\hat{V}} k_1$
relative to that of an arbitrary supernova  $\gamma^1_{\hat{V}} k_1|_0$. 

Analysis of this model produces $\gamma$ vectors that can be
transformed to the Fitzpatrick dust-extinction model with a corresponding $2.02 <R< 2.32$ 68\%-ile credible interval.

Suppose supernova color are determined by more than two parameters.  For example, supernovae have some intrinsic color dispersion
in addition to being obscured by two-parameter dust.  A feature of this model is that the two color vectors $\gamma$ try to capture all these effects.
...
\label{modelII:sec}
Model~II introduces an intrinsic color dispersion described by a 1-dimensional Normal distribution.  The supernova population
is described by an eigenvector $\vec{\phi}$ and the color offset of each supernova is parameterized by
\begin{equation}
...
Analysis of this model produces $\gamma$ vectors that can be
transformed to the Fitzpatrick dust-extinction model with a corresponding $2.34 <R< 2.73$ 68\% credible interval.

The posterior for $\sigma_p \vec{\phi}$ is shown in Figure~\ref{M1ev:fig}.  It is inconsistent with zero.  
The 68\% credible interval for $\sigma_p$ is $0.051^{+0.005}_{-0.004}$~mag, highly incompatible with zero, The median values
for each element are $(0.010, -0.021, -0.021, -0.008, 0.036)$.  The direction of $\phi$ is not aligned with the plane defined by
the $\gamma$ vectors; the 68\% credible interval for the  quadratic fraction of
$\phi$ in the $\gamma_0$--$\gamma_1$ plane is $0.088^{+0.118}_{-0.063}$.

\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   \centering
   \includegraphics[width=4in]{../output_fix3/sigev.pdf} 
            \caption{Model~II posterior  contours for $\sigma_p \vec{\phi}$.           \label{M1ev:fig}}
\end{figure}
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   \centering
   \includegraphics[width=3.5in]{../output_fix3/childress.pdf} 
   \caption{Intrinsic parameter
 $p$ as a function of host-galaxy mass
    \label{childress:fig}}
\end{figure}

\section{Model I and Model II Comparison}
Model~II introduces a degree of freedom that is associated with a Normal distribution.
It is thus interesting to compare the distributions of the $k_0$ and $k_1$ parameters of Model~I and Model~II,
which are shown in Figure~\ref{kcomp:fig}.  The apparent difference between Model~I and II is in the $\gamma^1k_1$ term,
...
This results in a change in the direction of the fit $\gamma^1$ and shifts the inferred Fitzpatrick $R$ to higher values.
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   ...
   Normalized stack of the posteriors of all supernovae  and histogram 
      of  per-supernova 
median values of $\gamma^0_{\hat{V}} k_0-\gamma^0_{\hat{V}} k_0|_0$.  Right:  The same plots for $\gamma^1_{\hat{V}} k_1-\gamma^1_{\hat{V}} k_1|_0$,
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   \centering
   \includegraphics[width=5.2in]{residual.pdf} 
            \caption{
            Model-expectation colors (including  supernova-specific spectral features and $\gamma k$ terms)
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   \centering
   \includegraphics[width=5.2in]{deltaDelta_hist.pdf} 
   \caption{
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   \centering
   \includegraphics[width=5.2in]{avebv_synth.pdf}
      \caption{
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   \centering
   \includegraphics[width=5in]{x1D.pdf}
    \caption{The
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   \centering
   \includegraphics[width=5.2in]{residualx1.pdf}
    \caption{Differences between observed colors and the 
    expected colors
...
The posterior for each realization was analyzed individually, and greeneriors of all realizations were stacked.
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   \centering
   \includegraphics[width=5.2in]{simdelta_corner.pdf} 
            \caption{Stacked $\vec{\delta}$ posterior contours for 100  independent simulated data sets.
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   \centering
   \includegraphics[width=5.2in]{simcoeff0.pdf} 
            \caption{Aggregated Model~II posterior contours for $\vec{c}$, $\vec{\alpha}$, $\vec{\beta}$, $\vec{\eta}$, $\vec{\gamma}^0$, $\vec{\gamma}^1$,  $\vec{\delta}$, and $\sigma$ in the ${\hat{U}}$ band of  100 independent simulated data sets.  The blue crosshairs denote the input $\vec{\delta}$ used to generate the simulated data.
            \label{simglobal1:fig}}
\end{figure}

\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   \centering
   \includegraphics[width=5.2in]{simcoeff1.pdf} 
            \caption{Aggregated Model~II posterior contours for $\vec{c}$, $\vec{\alpha}$, $\vec{\beta}$, $\vec{\eta}$, $\vec{\gamma}^0$, $\vec{\gamma}^1$,  $\vec{\delta}$, and $\sigma$ in the ${\hat{B}}$ band of  100 independent simulated data sets.  The blue crosshairs denote the input $\vec{\delta}$ used to generate the simulated data.
 \label{simglobal2:fig}}
\end{figure}

\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   \centering
   \includegraphics[width=5.2in]{simcoeff2.pdf} 
            \caption{Aggregated Model~II posterior contours for $\vec{c}$, $\vec{\alpha}$, $\vec{\beta}$, $\vec{\eta}$, $\vec{\gamma}^0$, $\vec{\gamma}^1$,  $\vec{\delta}$, and $\sigma$ in the ${\hat{V}}$ band of  100 independent simulated data sets.   The blue crosshairs denote the input $\vec{\delta}$ used to generate the simulated data. \label{simglobal3:fig}}
\end{figure}

\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   \centering
      \includegraphics[width=5.2in]{simcoeff3.pdf} 
            \caption{Aggregated Model~II posterior contours for $\vec{c}$, $\vec{\alpha}$, $\vec{\beta}$, $\vec{\eta}$, $\vec{\gamma}^0$, $\vec{\gamma}^1$,  $\vec{\delta}$, and $\sigma$ in the ${\hat{R}}$ band of  100  independent simulated data sets.   The blue crosshairs denote the input $\vec{\delta}$ used to generate the simulated data.
\label{simglobal4:fig}}
\end{figure}

\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   \centering
         \includegraphics[width=5.2in]{simcoeff4.pdf} 
            \caption{Aggregated Model~II posterior contours for $\vec{c}$, $\alpha$, $\vec{\beta}$, $\vec{\eta}$, $\vec{\gamma}^0$, $\vec{\gamma}^1$,  $\vec{\delta}$, and $\sigma$ in the ${\hat{I}}$ band of  100 independent simulated data sets.  The blue crosshairs denote the input $\vec{\delta}$ used to generate the simulated data.
