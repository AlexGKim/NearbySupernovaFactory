...
\epsilon_\Delta  = -  \epsilon_{\alpha} (EW_{\text{Ca}}-\langle EW_{\text{Ca}}\rangle)- 
 \epsilon_{\beta} (EW_{\text{Si}}-\langle EW_{\text{Si}}\rangle) -  \epsilon_{\eta} (\lambda_{\text{Si}}-\langle \lambda_{\text{Si}}\rangle)
- \epsilon_{\gamma^0}g_0 -  \epsilon_{\gamma^1}g_1.
$$
We break this degeneracy by fixing the values of $\epsilon$ such that $\Delta$ is
uncorrelated with  $EW_{\text{Ca}}$, $EW_{\text{Si}}$, $\lambda_{\text{Ca}}$,
$g_0$, and $g_1$.
...
color nor of extreme catastrophic outliers.
}
