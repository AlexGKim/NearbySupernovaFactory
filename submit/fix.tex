...
\item \added{We have defined an effective parameter $\langle R^F\rangle$ whose value may be compared with dust models.
...
\replaced{Based on these facts, the supernova ``extrinsic'' colors $\vec{\gamma}^0 g_0 + \vec{\gamma}^1 g_1$  of our model are attributed to dust extinction.
