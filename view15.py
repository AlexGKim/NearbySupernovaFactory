...
pp = PdfPages("output15/egammaedelta_corner.pdf")
...
pp = PdfPages("output15/Rveff4.pdf")
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
pp = PdfPages("output15/Rveff.pdf")
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
pp = PdfPages("output15/Rveff2.pdf")
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
plt.ylabel(r'$R_{eff,U} - R_{eff,V}$')
pp = PdfPages("output15/Rveff3.pdf")
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
filename = 'output15/residual.pdf'
...
fig.subplots_adjust(hspace=.3)
fig.set_size_inches(8,11)
filename = 'output15/residualx1.pdf'
pp = PdfPages(filename)
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
plt.xlabel(r'$\Delta$')
pp = PdfPages('output15/Delta_hist.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
plt.title(r'$k$')
pp = PdfPages('output15/k_hist.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
plt.title(r'$k1$')
pp = PdfPages('output15/k1_hist.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
plt.title(r'$D$')
pp = PdfPages('output15/D_hist.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
# pp = PdfPages('output15/ebvvsobs.pdf')
# plt.savefig(pp,format='pdf')
# pp.close()
# plt.close()
...
# plt.ylim((-0.8,0.1))
# pp = PdfPages('output15/Rveffres.pdf')
# plt.savefig(pp,format='pdf')
# pp.close()
# plt.close()
...
# pp = PdfPages('output15/ebvebv.pdf')
# plt.savefig(pp,format='pdf')
# pp.close()
# plt.close()
...
# pp = PdfPages('output15/alpham4_corner.pdf')
# plt.savefig(pp,format='pdf')
# pp.close()
# plt.close()
...
pp = PdfPages('output15/beta_corner.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
pp = PdfPages('output15/eta_corner.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
# pp = PdfPages('output15/betam4_corner.pdf')
# plt.savefig(pp,format='pdf')
# pp.close()
# plt.close()
...
# pp = PdfPages('output15/rx-rv_corner.pdf')
# plt.savefig(pp,format='pdf')
# pp.close()
# plt.close()
...
pp = PdfPages('output15/sigma_corner.pdf')
plt.savefig(pp,format='pdf')
pp.close()
plt.close()
...
with PdfPages('output15/multipage_pdf.pdf') as pdf:
    ...
    pp = PdfPages('output15/rx_corner.pdf')
    plt.savefig(pp,format='pdf')
    pp.close()
    plt.close()
